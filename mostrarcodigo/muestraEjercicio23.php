...
<!-- Motrar Codigo Ejercicio 23. Construir un formulario para recoger un cuestionario realizado a una persona y 
...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Sonia Anton Llanes - Ejercicio 23</title>
    ...
    <body>
        ...
        <h3>Código Ejercicio 23. Construir un formulario para recoger un cuestionario realizado a una persona y 
mostrar en la misma página las preguntas y las respuestas recogidas; 
en el caso de que alguna respuesta esté vacía o errónea volverá a salir el formulario con el mensaje correspondiente</h3>
        <div class="php">
            <?php
