...
<!-- Motrar Codigo Ejercicio 5: Inicializar y mostrar una variable que tiene una marca de tiempo (timestamp) -->
...
<html lang="es">
    ...
    <body>
        ...
        <h3>Código Ejercicio 5. Inicializar y mostrar una variable que tiene una marca de tiempo (timestamp).</h3>
        <div class="php">
            <?php
