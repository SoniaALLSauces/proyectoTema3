...
<!-- Motrar Codigo Ejercicio 13. Crear una función que cuente el número de visitas a la página actual desde una fecha concreta -->
...
<html lang="es">
    ...
    <body>
        ...
        <h3>Código Ejercicio 13. Crear una función que cuente el número de visitas a la página actual desde una fecha concreta</h3>
        <div class="php">
            <?php
