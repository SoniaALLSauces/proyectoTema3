...
<!-- Motrar Codigo Ejercicio 7. Mostrar el nombre del fichero que se está ejecutando -->
...
<html lang="es">
    ...
    <body>
        ...
        <h3>Código Ejercicio 7. Mostrar el nombre del fichero que se está ejecutando</h3>
        <div class="php">
            <?php
