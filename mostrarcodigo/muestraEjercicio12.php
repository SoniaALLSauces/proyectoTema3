...
<!-- Motrar Codigo Ejercicio 12. Mostrar el contenido de las variables superglobales (utilizando print_r() y foreach()) -->
...
<html lang="es">
    ...
    <body>
        ...
        <h3>Código Ejercicio 12. Mostrar el contenido de las variables superglobales (utilizando print_r() y foreach())</h3>
        <div class="php">
            <?php
