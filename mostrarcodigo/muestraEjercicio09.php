...
<!-- Motrar Codigo Ejercicio 8. Mostrar la dirección IP del equipo desde el que estás accediendo -->
...
<html lang="es">
    ...
    <body>
        ...
        <h3>Código Ejercicio 9. Mostrar el path donde se encuentra el fichero que se está ejecutando</h3>
        <div class="php">
            <?php
