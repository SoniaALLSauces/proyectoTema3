...
<!-- Motrar Codigo Ejercicio 10. Mostrar el contenido del fichero que se está ejecutando -->
...
<html lang="es">
    ...
    <body>
        ...
        <h3>Código Ejercicio 10. Mostrar el contenido del fichero que se está ejecutando</h3>
        <div class="php">
            <?php
