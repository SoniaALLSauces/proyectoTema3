...
<!-- Created on: 10-octubre-2020 -->
<!-- Motrar Codigo Ejercicio 3: Mostrar fecha y hora actual formateada en castellano -->
...
<html lang="es">
    ...
    <body>
        ...
        <h3>Código Ejercicio 3. Mostrar fecha y hora actual formateada en castellano.</h3>
        <div class="php">
            <?php
