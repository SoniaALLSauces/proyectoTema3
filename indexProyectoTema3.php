...
<!-- Created on: 05-octubre-2020 -->
<!-- Index Ejercicios del Tema 3 DWES -->

<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Sonia Anton Llanes - Index General DAW2</title>
	...
	<main class="main">
            <section>
                ...
                <table>
                    ...
                    <tr class="tr"> 
                        <td class="ejercicio">Ejercicio 00. Hola mundo y phpinfo()</td>
                    ...
                    <tr class="tr">
                        <td class="ejercicio">Ejercicio 01. Inicializar variables de los distintos tipos básicos y mostrarlas por pantalla</td>
                    ...
                    <tr class="tr">
                        <td class="ejercicio">Ejercicio 2. Inicializar y mostrar una variable heredoc</td>
                    ...
                    <tr class="tr">
                        <td class="ejercicio">Ejercicio 3. Mostrar en tu página index la fecha y hora actual formateada en castellano. <br> (Utilizar cuando sea posible la clase DateTime)</td>
                        <td class="tdimg"><a href="codigoPHP/ejercicio03.php"><img src="webroot/images/ejecutar.png" alt="ejecutar"></a></td>
                        <td class="tdimg"><a href="mostrarCodigo/muestraEjercicio03.php"><img src="webroot/images/mostrar.png" alt="mostrar"></a></td>
                    </tr>
                    <tr class="tr">
                        <td class="ejercicio">Ejercicio 4. Mostrar en tu página index la fecha y hora actual en Oporto formateada en portugués.</td>
                        <td class="tdimg"><a href="codigoPHP/ejercicio04.php"><img src="webroot/images/ejecutar.png" alt="ejecutar"></a></td>
